...
const FeaturedPostCard = ({
  ...
  return (
    ...
    >
      <article
        className="transition-all duration-300 ease-in-out relative hover:shadow-lg cursor-pointer rounded-[20px] overflow-hidden w-full h-full sm:h-[380px] md:h-[480px]"
        style={{ isolation: "isolate" }}
      >
        {/* Overlay */}
        <div
          className={`absolute top-0 left-0 w-full h-full sm:h-[380px] md:h-[480px] bg-black/60 z-[2] transition-opacity duration-300 ${
