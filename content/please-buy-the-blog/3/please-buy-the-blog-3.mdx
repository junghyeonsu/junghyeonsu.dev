...
<head>
  ...
  <meta
    property="og:image"
    content="https://ia.media-imdb.com/images/rock.webp"
  />
  <!-- ... -->
</head>
```
...
const CustomHead = ({ post, type }: CustomHeadInterface) => {
  return type === "posting" ? (
    ...
    <Head>
      ...
      <meta
        property="og:image"
        content="https://github.com/junghyeonsu/junghyeonsu.dev/blob/main/public/profile.webp?raw=true"
      />
      {/*  Twitter Meta Tags  */}
      <meta name="twitter:card" content="summary_large_image" />
      <meta property="twitter:domain" content="junghyeonsu.com" />
