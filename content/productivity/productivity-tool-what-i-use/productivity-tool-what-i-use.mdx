...
title: "개발의 효율성을 높여주는 생산성 도구들 1탄(vscode extension, keyboard shortcut, vscode 익스텐션, 키보드 숏컷)"
...
![import-organize keyboard short cut](./import-organize.webp)
...
![copy-line keyboard short cut](./copy-line.webp)
...
![move-line keyboard short cut](./move-line.webp)
...
![select-multi-line keyboard short cut](./select-multi-line.webp)
...
![add-cursor keyboard short cut](./add-cursor.webp)
...
![file-tree-generator 1](./file-generator-1.webp)

![file-tree-generator 2](./file-generator-2.webp)

트리를 뽑고자 하는 폴더의 오른쪽을 클릭하면 맨 아래에 `generate to tree` 라는 버튼이 생긴다.
클릭하면 아래와 같이 텍스트의 형태로 폴더 구조가 나오게 된다.

![file-tree-generator 3](./file-generator-3.webp)
...
```html
📦blog ┣ 📂blog-bottom-line ┃ ┗ 📂2022-Q2 ┃ ┃ ┣ 📜1.webp ┃ ┃ ┣ 📜10.webp ┃ ┃ ┣ ... ┃ ┃ ┗ 📜cover.webp ┣
📂computer-science ┃ ┣ 📂What-is-DNS ┃ ┃ ┣ 📜.DS ┃ ┃ ┣ 📜1.webp ┃ ┃ ┣ 📜2.webp ┃ ┃ ┣ 📜3.webp ┃ ┃ ┗
📜cover.webp ┃ ┣ 📂What-is-http ┃ ┃ ┣ 📜1.webp ┃ ┃ ┣ 📜2.webp ┃ ┃ ┣ 📜3.webp ┃ ┃ ┣ ...
```
...
![root option을 true로 주자.](./eslint-5.webp)
...
![giphy capture는 mac에서만 다운받을 수 있다.](./giphy-1.webp)
