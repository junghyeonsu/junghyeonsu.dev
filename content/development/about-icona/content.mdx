...
![발표 자료의 한 장면, 대충 요구사항들을 위의 세가지를 이용해서 해결했다는 내용](./1.webp)
...
![현재는 배포 버튼을 누르면 아이콘 데이터 파일의 경로가 `.icona/icons.json`으로 고정 돼 있다.](./2.webp)
