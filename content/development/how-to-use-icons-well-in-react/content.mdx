...
type IconName = "icon_add_circle_fill" | "icon_add_circle_regular" | "icon_add_circle_thin";
```
...
export const SeedIconProvider = ({
  ...
  return <SeedIconContext.Provider value={spriteUrl}>{children}</SeedIconContext.Provider>;
};
```
