...
![https://github.com/nodejs/node/issues/33954](./1.webp)
...
![TypeScript 잘 되는거 확인하고 각각 어떤 모듈 사용하는지 확인](./4.webp)
...
![프로젝트에서 node_modules 폴더에 .bin 폴더를 확인해보세요.](./5.webp)
...
![쉽게 생각해서 .bin에서 node 환경에서 동작하는 파일입니다.](./6.webp)
