...
![development와 production으로 된 dataset이 있어야 환경 분리가 됩니다.](./3.webp)
...
![Publish 버튼을 통해서 데이터를 배포할 수 있습니다.](./6.webp)
...
![현재는 Sanity에서 제공하는 기본적인 컴포넌트들로 구성되어 있습니다.](./11.webp)
