...
![우리가 작성한 index.js파일이 node_modules안에 잘 들어가 있다.](./1.webp)
...
![junghyeonsu-utils를 설치하고 node_modules를 확인](./7.webp)
